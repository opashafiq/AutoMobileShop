...
export const HeroSection = () => {
  ...
  const TechnStacks = [
    ...
    {
      key: 'tech6',
      img: '/images/frontend-pages/technology/headless-ui-seeklogo.svg',
      title: 'Headless UI',
    },
  ]
          ...
          <div className='w-full pt-5'>
            ...
            <div className='w-full relative p-3 img-wrapper'>
              ...
              <Image
                ...
                width={300}
                height={200}
                className='absolute top-0 start-0 rounded-2xl custom-shadow animated-img xl:block hidden'
              />
              <Image
                ...
                width={300}
                height={200}
                className='absolute -top-7 end-0 rounded-2xl custom-shadow animated-img xl:block hidden'
              />
            </div>
            <div className='mt-4'>
              <Image
