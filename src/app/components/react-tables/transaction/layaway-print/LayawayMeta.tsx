...
interface LayawayMetaProps {
  master: LayawayMasterDto
}
...
/**
 * Transaction metadata row: Layaway #, Date, Payment Status.
 * Displays as a clean horizontal bar beneath the header.
 */
export default function LayawayMeta({ master }: LayawayMetaProps) {
  return (
