...
import AnimatedSlider from "../../animatedComponents/AnimatedSlider";
    ...
    return (
        <Card className="h-full flex flex-col justify-between gap-6">
            ...
            <Card className="bg-lightprimary dark:bg-lightprimary mt-7 shadow-none" >
                <Image src={'/images/music/album3.jpg'} alt="album" width={100} height={100} className="rounded-md mx-auto" />
                                ...
                                <div key={item.key} className="p-4 py-[17px] hover:bg-lightprimary rounded-md overflow-hidden cursor-pointer border-b last:border-b-0 border-border dark:border-darkborder">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3.5">
                                            <Image src={item.album} alt="album" width={40} height={40} className="h-11 w-11 rounded-md" />
                                            <div>
