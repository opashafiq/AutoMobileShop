            ...
            return (
              <div className="lg:col-span-4 col-span-12" key={item.key}>
                <Card className="p-0 overflow-hidden group">
                  <Link href="#">
                    <Image src={item.album} alt="album" width={30} height={30} className="max-w-full w-full group-hover:scale-[1.03] duration-300" />
                  </Link>
                  <div className="p-3 flex justify-between">
                    ...
                    <div onClick={() => togglePlay(item.key)} className="w-9 h-9 bg-white relative z-10 cursor-pointer text-primary flex items-center justify-center rounded-full -mt-[30px] hover:bg-primary hover:text-white">
                      <Icon
