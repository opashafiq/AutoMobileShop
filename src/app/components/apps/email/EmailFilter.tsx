        ...
        <ul className="my-4">
          {filterData.map((item) => {
            ...
            return (
              <li
                key={item.id}
                className={`py-[10px] gap-2 px-4 rounded-md cursor-pointer capitalize flex ${filter === item.name ? "text-primary  dark:bg-lightprimary" : "bg-hover  rounded-md text-bodytext dark:text-darklink"}`}
