...
function ContactList({ openContact }: ContactListProps) {
  ...
  return (
    <>
      <SimpleBar className="md:h-[calc(100vh_-_395px)] h-[calc(100vh_-_200px)]">
      ...
      <Dialog open={openContactModal} onOpenChange={setOpenContactModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-center">Are you sure you want to delete this contact?</DialogTitle>
          </DialogHeader>
