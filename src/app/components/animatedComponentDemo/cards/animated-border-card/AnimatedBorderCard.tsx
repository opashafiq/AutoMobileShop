...
import AnimatedBorderCardMotionCode from './AnimatedBorderCardMotion'
...
.media-object::before {
  ...
  background-image: conic-gradient(from var(--angle), #381d6a00 80%, var(--color-primary), var(--color-primary), #381d6a00 100%);
...
.border-card__description {
  color: var(--text-color-2);
  line-height: 24px;
  margin-block: 0;
}

.border-card__actions {
  display: flex;
  gap: 24px;
}
...
.source-link.source-link--second {
  ...
  return (
    <>
      <CodePreview
        component={<AnimatedBorderCardMotionCode />}
        cssCode={cssCode}
        filePath='src/app/components/animatedComponentDemo/cards/animated-border-card/AnimatedBorderCardMotion.tsx'
        title='Bordered Card Motion'
        isAnimated={true}
      />
    </>
  )
