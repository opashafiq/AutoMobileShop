...
function PlaceholdersInput({ placeholders }: { placeholders: string[] }) {
  ...
  return (
    <form
      ...
      <Input
        ...
        type='text'
        className={cn(
          'w-full bg-transparent pl-4 pr-20 text-sm text-black focus:outline-none dark:text-white sm:text-base',
...
export default function InputPlaceholderAnimate() {
  ...
  return (
    <>
      <PlaceholdersInput placeholders={placeholders} />
    </>
  )
}
