    ...
    <div className='w-full' {...getRootProps()}>
      <motion.div
        ...
        <div className='flex flex-col items-center justify-center'>
          <p className='relative font-bold text-dark dark:text-neutral-300 text-xl'>
            Upload file
          </p>
          <p className='relative font-normal text-neutral-400 dark:text-neutral-400 text-base mt-2'>
...
const FileItem: React.FC<FileItemProps> = ({
  ...
  <motion.div
    ...
    className={cn(
      'relative overflow-hidden bg-white dark:bg-white/10 flex flex-col items-start justify-start md:h-24 p-4 mt-4 w-full mx-auto rounded-md shadow-sm'
    )}>
...
const EmptyState: React.FC<EmptyStateProps> = ({ isDragActive }) => (
  <>
    <motion.div
      ...
      className={cn(
        'relative group-hover/file:shadow-2xl z-20 bg-white dark:bg-white/10 flex items-center justify-center h-28 mt-4 w-full max-w-[8rem] mx-auto rounded-md shadow-[0px_10px_50px_rgba(0,0,0,0.1)]'
      )}>
      {isDragActive ? (
        <motion.p
          initial={{ opacity: 0 }}
    ...
    <motion.div
      ...
      className='absolute opacity-0 border border-dashed border-primary inset-0 bg-transparent flex items-center justify-center h-28 mt-4 w-full max-w-[8rem] mx-auto rounded-md'
    />
  </>
)
...
export default function FileUploadMotion() {
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto min-h-72 border border-dashed bg-white dark:bg-dark border-border rounded-lg'>
