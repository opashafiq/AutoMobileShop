...
const COMPANY_NAME = process.env.COMPANY_NAME ?? 'Apollo Tire & Wheel'
export const metadata: Metadata = {
  title: `Login To ${COMPANY_NAME}`,
  description: `Generated by ${COMPANY_NAME} - Login Page`,
}
      ...
      <div className='relative overflow-hidden h-screen'>
        <div className='grid grid-cols-12 gap-3 h-screen bg-white dark:bg-dark'>
          ...
          <div className='xl:col-span-4 lg:col-span-5 col-span-12 sm:px-12 p-5'>
            <div className='flex h-screen items-center px-3 lg:justify-center justify-center'>
              <div className='max-w-[420px] w-full mx-auto'>
                <h3 className='text-2xl font-bold'>Welcome to {COMPANY_NAME}</h3>
