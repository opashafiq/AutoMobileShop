  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        id: uniqueId(),
        url: "/react-tables/master/company-info",
      },
      {
        name: "Departments",
        icon: "solar:archive-minimalistic-linear",
        id: uniqueId(),
        url: "/react-tables/master/departments",
      },
      {
        name: "Distributors",
        icon: "solar:user-id-linear",
        id: uniqueId(),
        url: "/react-tables/master/distributors",
      },
      {
        name: "Expense Heads",
        icon: "solar:wallet-linear",
        id: uniqueId(),
        url: "/react-tables/master/expense-head",
      },
      {
        name: "Item Master",
      ...
      },
      {
        ...
        id: uniqueId(),
        url: "/react-tables/master/location-details",
      },
      {
        name: "Refund Method Names",
        icon: "solar:undo-left-round-linear",
        id: uniqueId(),
        url: "/react-tables/master/refund-method-name",
      },
      {
        name: "Roles",
        icon: "solar:user-check-linear",
        id: uniqueId(),
        url: "/react-tables/master/roles",
      },
      {
        name: "Tax Rate Modified",
        icon: "solar:chart-square-linear",
        id: uniqueId(),
        url: "/react-tables/master/tax-rate-modified",
      },
    ],
 },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: "solar:undo-left-round-square-linear",
        id: uniqueId(),
        url: "/react-tables/transaction/layaway-refund",
      },
    ],
  },
  {
